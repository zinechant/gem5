...
#include "mem/streamssd/bil/noop_scheduler.hh"
#include "simplessd/sim/trace.hh"

namespace BIL {

BlockIOEntry::BlockIOEntry(Engine &e, DriverInterface *i, std::ostream *o)
    : engine(e),
      pLatencyFile(o),
      pScheduler(nullptr),
      lastProgress(0),
...
BlockIOEntry::~BlockIOEntry() { delete pScheduler; }
